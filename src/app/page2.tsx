...
function Main() {
  ...
  const getAllTasks = async () => {
    const responseTasksApi = await useApi.getExampleTasks();
...
type ServerProps = {
  idToken: string; // Defina o tipo da prop "date" como string
}
...
/* export const getServerSideProps: GetServerSideProps = async () => {
  ...
  let idToken: string = await useApi.getUserIdFromToken();
  console.log(idToken);
